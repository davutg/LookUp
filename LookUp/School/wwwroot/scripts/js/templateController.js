(function () {
    ...
    function templateController($scope) {
        ...
        vm.templateList = [ { name: "yeti", address: "../scripts/lib/bootswatch/yeti/bootstrap.min.css" },
                            ...
                            { name: "darkly", address: "../scripts/lib/bootswatch/darkly/bootstrap.min.css" },
                            { name: "paper", address: "../scripts/lib/bootswatch/paper/bootstrap.min.css" },
                            { name: "sandstone", address: "../scripts/lib/bootswatch/sandstone/bootstrap.min.css" },
                            { name: "superhero", address: "../scripts/lib/bootswatch/superhero/bootstrap.min.css" }
        ];
